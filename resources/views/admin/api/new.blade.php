            ...
            <div class="col-sm-8 col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">アクセス許可を選択</h3>
                    </div>
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <p class="text-muted">一度アクセス許可を割り当て、この資格情報を作成したら、戻って編集することはできません。将来的に変更を加える必要がある場合は、新しい資格情報セットを作成する必要があります。</p>
                    </div>
                    <div class="box-footer">
                        {{ csrf_field() }}
                        <button type="submit" class="btn btn-success btn-sm pull-right">資格情報の作成</button>
                    </div>
                </div>
            </div>
        </form>
