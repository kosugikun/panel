...
@section('content-header')
    <h1>ロケーション<small>ノードが簡単に分類できるすべてのロケーション。</small></h1>
    <ol class="breadcrumb">
            ...
            <div class="modal-content">
                <form action="{{ route('admin.locations') }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">ロケーションの作成</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">他と区別するために使用される短い識別子。1から60文字の間で、例えば<code>us.nyc.lvl3</code>のようにしてください。</p>
                            </div>
                            <div class="col-md-12">
                                <label for="pLongModal" class="form-label">説明</label>
                                <textarea name="long" id="pLongModal" class="form-control" rows="4"></textarea>
                                <p class="text-muted small">このロケーションの詳細な説明。191文字未満である必要があります。</p>
                            </div>
                        </div>
                    </div>
