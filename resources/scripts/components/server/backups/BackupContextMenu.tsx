...
export default ({ backup }: Props) => {
    ...
    return (
        <>
            ...
            >
                このバックアップは、自動的または誤って削除される危険性から保護されなくなります。
            </Dialog.Confirm>
            <Dialog.Confirm
                open={modal === 'restore'}
                onClose={() => setModal('')}
            ...
            >
                <p>
                    サーバーが停止されます。完了するまで電源状態を制御したり、ファイルマネージャにアクセスしたり、追加のバックアップを作成したりすることはできません。
                </p>
            ...
            >
                これは永久的な操作です。一度削除されたバックアップは回復できません。
            </Dialog.Confirm>
                    ...
                    <div css={tw`text-sm`}>
                        <Can action={'backup.download'}>
                            <DropdownButtonRow onClick={doDownload}>
                                ...
                                <span css={tw`ml-2`}>ダウンロード</span>
                            </DropdownButtonRow>
                        </Can>
                        <Can action={'backup.restore'}>
                            <DropdownButtonRow onClick={() => setModal('restore')}>
                                <FontAwesomeIcon fixedWidth icon={faBoxOpen} css={tw`text-xs`} />
                                <span css={tw`ml-2`}>復元</span>
                            </DropdownButtonRow>
                        </Can>
